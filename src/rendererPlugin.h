...
//
#ifndef EXTRAS_IMAGING_EXAMPLES_HD_RDN_RENDERER_PLUGIN_H
#define EXTRAS_IMAGING_EXAMPLES_HD_RDN_RENDERER_PLUGIN_H
...
///
class HdRdnRendererPlugin final : public HdRendererPlugin 
{
public:
    HdRdnRendererPlugin() = default;
    virtual ~HdRdnRendererPlugin() = default;

    /// Construct a new render delegate of type HdRdnRenderDelegate.
...
private:
    ...
    HdRdnRendererPlugin(const HdRdnRendererPlugin&) = delete;
    HdRdnRendererPlugin &operator =(const HdRdnRendererPlugin&) = delete;
};

PXR_NAMESPACE_CLOSE_SCOPE

#endif // EXTRAS_IMAGING_EXAMPLES_HD_RDN_RENDERER_PLUGIN_H
